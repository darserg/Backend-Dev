...
def get_stickers_comparison(collection_1, collection_2):
    collection_1 = set(collection_1)
    collection_2 = set(collection_2)
    return (
        sorted(list(set.difference(collection_1, collection_2))),
        sorted(list(set.difference(collection_2, collection_1))),
        sorted(list(collection_1 & collection_2)),
    )
